...
public class search_2d_matrix {
     ...
     * Because of the two properties, if we flatten the 2D matrix into a 1D array, 
     * it will be strictly sorted. 
     * However, we don't need to actually flatten it (which takes O(M*N) time and space).
     * We just imagine it's a 1D array of size M * N, and use math to map the 1D index 
     * back to the 2D (row, col) coordinates.
     * 
     * Mapping formula:
     * row = index / cols
     * col = index % cols
