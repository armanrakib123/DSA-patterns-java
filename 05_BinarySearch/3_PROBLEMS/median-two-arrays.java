 ...
 * Category: Hard (One of the most famous Hard problems in Software Company)
 * 
...
public class median_two_arrays {
    ...
    /**
     * Approach: Binary Search on the smaller array The median splits the
     * combined array into two equal halves. We can find a "Partition" in nums1
     * and a corresponding "Partition" in nums2 such that the left half has the
