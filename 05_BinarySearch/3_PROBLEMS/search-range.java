...
public class search_range {
    ...
    /**
     * Approach: Lower Bound trick lowerBound(target) gives the FIRST index
     * where target can be inserted. lowerBound(target + 1) gives the FIRST
     * index where (target + 1) can be inserted. Therefore, the last index of
     * target is simply `lowerBound(target + 1) - 1`.
     *
