 ...
 * Category: Medium (Software Company Favorite - Google/Meta)
 * 
...
public class first_last_position {
    ...
    /**
     * Approach: Two Binary Searches (Lower Bound and Upper Bound) We cannot
     * just find the element and expand outwards linearly, because if all
     * elements are the target, expansion takes O(N) time. We MUST do two
     * separate O(log N) binary searches.
     *
