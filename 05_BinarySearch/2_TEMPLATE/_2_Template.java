 ...
 * FAANG ইন্টারভিউতে বাইনারি সার্চে ছোটখাটো (Off-by-one) ভুলের কারণে অনেক ক্যান্ডিডেট বাদ পড়ে।
 ...
 */
 ...
 public class _2_Template {
     ...
     * একটি নির্দিষ্ট টার্গেট ভ্যালু খুঁজে বের করা। না পেলে -1 রিটার্ন করা।
     */
    ...
    /**
     * Pattern 2: Lower Bound (First occurrence / Insert Position)
     * টার্গেটের সমান বা তার চেয়ে বড় প্রথম ইলিমেন্টের ইনডেক্স বের করা।
     * টার্গেট Array তে না থাকলেও এটি যে পজিশনে বসালে সর্টেড থাকবে (Insert Position), তা রিটার্ন করে।
     */
