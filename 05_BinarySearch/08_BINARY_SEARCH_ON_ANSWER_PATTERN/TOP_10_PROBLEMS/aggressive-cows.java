 ...
 *
 * Problem: Farmer John has built a new long barn, with N stalls. The stalls are
 * located along a straight line at positions x1,...,xN. His C cows don't like
 * this barn layout and become aggressive towards each other once put into a
 * stall. To prevent the cows from hurting each other, FJ wants to assign the
 * cows to the stalls, such that the minimum distance between any two of them is
 * as large as possible. What is the largest minimum distance?
 */
public class aggressive_cows {

    /**
     * Approach: Binary Search on Answer (Maximize the Minimum) Pattern: T T T F
     * F F (We want the last True) The minimum possible distance is 1. The
     * maximum possible distance is (Max Stall Position - Min Stall Position).
     *
    ...
    /**
     * Helper: Checks if we can place 'm' cows such that every cow is at least
     * 'distance' apart.
     */
