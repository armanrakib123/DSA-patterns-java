 ...
 * Category: Medium (FAANG Favorite - The easiest entry into BS on Answer)
 * 
...
public class koko_eating_bananas {
     ...
     * The answer 'k' (speed) must be between 1 and the maximum pile size.
     * We binary search for the MINIMUM 'k' that allows her to finish within 'h' hours.
     * 
     * Time Complexity: O(N log M) where N is piles length, M is the max pile size.
    ...
    /**
     * Helper: Checks if it's possible to eat all bananas at speed 'k' within 'h' hours.
     */
    private boolean canFinish(int[] piles, int h, int k) {
        ...
        for (int pile : piles) {
            ...
            // This is a pro FAANG trick! (A + B - 1) / B
