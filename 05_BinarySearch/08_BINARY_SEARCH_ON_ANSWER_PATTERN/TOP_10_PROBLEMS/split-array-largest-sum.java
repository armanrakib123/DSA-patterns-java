...
public class split_array_largest_sum {
    ...
    /**
     * Approach: Binary Search on Answer This is fundamentally the EXACT same
     * problem as "Capacity To Ship Packages Within D Days". Think of elements
     * as packages and 'k' as days. The largest sum is the ship capacity.
     *
    ...
    /**
     * Helper: Checks if it is possible to split the array into at most 'k'
     * parts such that no part has a sum greater than 'maxSum'.
     */
