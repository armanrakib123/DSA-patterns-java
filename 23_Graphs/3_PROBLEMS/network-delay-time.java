 ...
 * Category: Medium (Dijkstra)
 * 
 * Problem: Find the minimum time it takes for all nodes to receive a signal from a source.
 */
public class network_delay_time {

    /**
     * Approach: Dijkstra's Algorithm
     * Find the shortest path to all nodes and take the maximum.
     * 
