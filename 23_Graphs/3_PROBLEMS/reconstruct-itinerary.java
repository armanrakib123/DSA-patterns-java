...
/**
 * LeetCode 332. Reconstruct Itinerary Category: Hard (Graph / Hierholzer's
 * Algorithm / Eulerian Path)
 */
public class reconstruct_itinerary {

    /**
     * Approach: Hierholzer's Algorithm (Post-order DFS) Visit edges in lexical
     * order and build the path from back to front.
     */
