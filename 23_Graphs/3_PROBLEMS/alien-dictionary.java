...
/**
 * LeetCode 269. Alien Dictionary (Premium) Category: Hard (Topological Sort)
 *
 * Problem: Given a list of words from an alien language, return the order of
 * characters.
 */
public class alien_dictionary {
     ...
     *
     * Time Complexity: O(Total letters in words) Space Complexity: O(Number of
     * unique letters)
     */
