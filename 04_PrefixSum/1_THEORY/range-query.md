...
ইফ-এলস (`if L == 0`) এর ঝামেলা এড়ানোর জন্য Software Company ইঞ্জিনিয়াররা একটি স্মার্ট ট্রিক ব্যবহার করেন। তারা Prefix Sum অ্যারের সাইজ ১ বাড়িয়ে (`N+1`) দেন এবং 1-based indexing ব্যবহার করেন।
