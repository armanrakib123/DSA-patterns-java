...
public class pivot_index {
    ...
    /**
     * Approach: Total Sum and Running Prefix Sum Instead of creating a new
     * array for Prefix Sum, we first calculate the total sum. Then we iterate
     * through the array maintaining a leftSum. Right sum can be dynamically
     * calculated as: totalSum - leftSum - nums[i].
     *
     * Time Complexity: O(N) Space Complexity: O(1) (Highly Optimized)
     */
