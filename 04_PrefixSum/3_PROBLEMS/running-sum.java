...
public class running_sum {
    ...
    /**
     * Approach: In-place Prefix Sum We don't need extra space because we can
     * modify the input array to hold the running sums.
     *
     * Time Complexity: O(N), where N is the length of nums. Space Complexity:
     * O(1) if modifying input, O(N) if a new array is required.
     */
