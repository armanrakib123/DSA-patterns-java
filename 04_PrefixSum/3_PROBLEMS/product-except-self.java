 ...
 * Category: Medium (Software Company Favorite - Amazon, Apple, Facebook)
 * 
...
public class product_except_self {
    ...
    /**
     * Approach: Prefix and Suffix Products (Space Optimized) Instead of using
     * sum, we use multiplication. We can think of it as Prefix Product.
     * answer[i] = (Product of elements to the left) * (Product of elements to
     * the right)
     *
     ...
     * The true Software Company level solution optimizes the space to O(1) by reusing the result array 
