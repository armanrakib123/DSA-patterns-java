...
public class count_vowel_strings {
    ...
    /**
     * Approach: 1D Prefix Sum Array Instead of checking vowels for each query
     * (which takes O(N * Q)), we create a boolean array mapping to 1 if a word
     * starts and ends with a vowel, else 0. Then we build a Prefix Sum array on
     * this boolean array to answer range queries in O(1).
     *
