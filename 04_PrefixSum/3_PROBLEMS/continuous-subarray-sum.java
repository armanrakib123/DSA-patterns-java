 ...
 * Category: Medium (Facebook/Meta frequent)
 * 
...
public class continuous_subarray_sum {
    ...
    /**
     * Approach: Prefix Sum + HashMap + Modulo Math
     * Math concept: If (sum_j % k) == (sum_i % k), then the subarray from i+1 to j is a multiple of k.
     * E.g. 23 % 6 = 5, and 29 % 6 = 5. Difference between 29 and 23 is 6, which is a multiple of 6.
     * 
     * Time Complexity: O(N)
     * Space Complexity: O(min(N, K)) for HashMap
     */
