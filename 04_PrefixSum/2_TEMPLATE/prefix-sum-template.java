package 03_PREFIX_SUM_PATTERN.TEMPLATE;

import java.util.HashMap;
import java.util.Map;

/**
 * FAANG Standard Prefix Sum Templates
 * This class contains standard patterns for Prefix Sum.
 */
public class prefix_sum_template {

    /**
     * 1. 1-Based Prefix Sum Array for Range Queries
    ...
    /**
     * 2. Running Sum with HashMap for "Subarray Sum Equals K" pattern
     * Time: O(N)
     * Space: O(N)
     */
    ...
    /**
     * 3. In-place Prefix Sum (When modification is allowed)
     * Time: O(N)
     * Space: O(1)
     */
