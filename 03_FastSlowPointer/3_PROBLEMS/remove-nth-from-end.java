...
public class remove_nth_from_end {
    ...
    /**
     * Approach: Fast & Slow Pointers (Two Pointers)
     * 1. Move the fast pointer n steps ahead.
     * 2. Move both slow and fast pointers until fast reaches the end.
     * 3. Slow will be pointing to the node before the one to be removed.
     * 
     * Time Complexity: O(N)
