...
/**
 * LeetCode 295. Find Median from Data Stream Category: Hard (Two Heaps Pattern)
 */
public class find_median_from_data_stream {
    ...
    class MedianFinder {
        ...
        /**
         * Approach: Two Heaps Maintain two heaps such that the difference in
         * size is at most 1.
         *
         * Time Complexity: O(log N) for addNum, O(1) for findMedian Space
         * Complexity: O(N)
         */
