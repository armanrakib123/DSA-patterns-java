...
/**
 * LeetCode 1167. Minimum Cost to Connect Sticks Category: Medium (Greedy +
 * Min-Heap)
 *
 * Problem: You have some sticks with positive integer lengths. You can connect
 * any two sticks of lengths x and y into one stick by paying a cost of x + y.
