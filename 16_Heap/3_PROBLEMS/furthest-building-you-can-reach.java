...
/**
 * LeetCode 1642. Furthest Building You Can Reach Category: Medium (Greedy +
 * Min-Heap)
 */
public class furthest_building_you_can_reach {

    /**
     * Approach: Greedy (Use ladders for the largest jumps) Use a Min-Heap to
     * track the largest jumps where ladders were used. If ladders are
     * exhausted, use bricks for the smallest jump in the heap.
     *
     * Time Complexity: O(N log L) where L is number of ladders Space
     * Complexity: O(L)
     */
