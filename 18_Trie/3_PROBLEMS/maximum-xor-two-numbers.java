...
public class maximum_xor_two_numbers {
    ...
    /**
     * Approach: Bitwise Trie (Greedy)
     * For each number, we want to find another number that has the opposite bit 
     * at each position (starting from most significant bit) to maximize XOR.
     * 
