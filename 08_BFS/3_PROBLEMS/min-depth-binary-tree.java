 ...
 * Category: Easy (BFS Shortest Path)
 * 
...
public class min_depth_binary_tree {
     ...
     * BFS is better than DFS here because we find the nearest leaf node level by level.
     * The first leaf node we encounter is guaranteed to be at the minimum depth.
     * 
     * Time Complexity: O(N)
