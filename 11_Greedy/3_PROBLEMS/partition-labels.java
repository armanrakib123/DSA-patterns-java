 ...
 * Category: Medium (Greedy + Hashing)
 */
public class partition_labels {

    /**
     * Approach: Last Occurrence tracking
     * For each character, find its last occurrence. 
     * The partition must be at least as far as the last occurrence of any character inside it.
     * 
     * Time Complexity: O(N)
