...
/**
 * LeetCode 455. Assign Cookies Category: Easy (Greedy + Sorting)
 */
public class assign_cookies {

    /**
     * Approach: Sort both and use Two Pointers Give the smallest possible
     * cookie that satisfies the child's greed.
     *
