...
24_GREEDY_PATTERN.TEMPLATE;

import java.util.*;

/**
 * Software Company Standard Greedy Algorithm Templates
 */
public class greedy_template {

    /**
     * Template 1: Interval Scheduling (Max non-overlapping) Sort by End Time
     */
    ...
    /**
     * Template 2: Greedy Choice with Sorting Common for problems like Assign
     * Cookies, Lemonade Change.
     */
    ...
    /**
     * Template 3: One-pass Greedy (Max Reach) Common for Jump Game, Gas
     * Station.
     */
